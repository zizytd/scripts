...
#visualize the CSVs
pd.read_csv("/Users/tochukwuonyido/Scripts/user_statistics.csv", index_col="Username")
pd.read_csv("/Users/tochukwuonyido/Scripts/error_message.csv", index_col="Error")
